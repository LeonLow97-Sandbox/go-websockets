...
func (m *postgresDBRepo) InsertHost(h models.Host) (int, error) {
	...
	stmt := `
		...
		status, created_at, updated_at) VALUES ($1, 2, 0, 3, 'm', 'pending', $2, $3)
	`
...
func (m *postgresDBRepo) UpdateHostService(hs models.HostService) error {
	...
	stmt := `
		...
		SET host_id = $1, service_id = $2, active = $3, schedule_number = $4,
			schedule_unit = $5, last_check = $6, status = $7, updated_at = $8, last_message = $9
		WHERE id = $10;
	`
